...
def save_results(players, rounds):
...
# ---- Setup players (minimal change) ----
players = copy.deepcopy(setup_players())   # ensure deepcopy used here too
